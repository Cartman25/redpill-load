...
BRP_DEBUG=1 BRP_USER_CFG=$PWD/user_config-ds3615.json ./build-loader.sh 'DS3617xs' '7.0.1-42218' "$PWD/images/rp-3617-v7.0.1$IMG_POSTFIX.img"
...
qemu-img convert -f raw -O vmdk "$PWD/images/rp-3615-v7.0.1$IMG_POSTFIX.img" "$PWD/images/vrp-3615-v7.0.1$IMG_POSTFIX.vmdk"
qemu-img convert -f raw -O vmdk "$PWD/images/rp-3617-v7.0.1$IMG_POSTFIX.img" "$PWD/images/vrp-3617-v7.0.1$IMG_POSTFIX.vmdk"
...
gzip "$PWD/images/rp-3615-v7.0.1$IMG_POSTFIX.img"
gzip "$PWD/images/rp-3617-v7.0.1$IMG_POSTFIX.img"
